...
*Now, time to find tendencies of success, starting with success based on down and distance.*
...
*Tendencies of success, based on combining formation and distance.*
...
*Instead of using downs on the x, we made a new logmodel, logmodel7 (see above for what that model entails)*

*This new model ended up being slighty better than logmodel2 anyways.*
...
*switch it from log odds to probability*
