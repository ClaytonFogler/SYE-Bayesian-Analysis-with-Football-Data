...
Our logistic Regression Model using DN (Down), DIST (Distance to go), and RP (whether the play was a run or pass) resulted in a classification rate of 0.606, meaning our model correctly predicted 61.8% of the plays.
